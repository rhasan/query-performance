...
X = csvread('../6000/x_features.txt');
Xval = csvread('../6000/xval_features.txt');
Xtest = csvread('../6000/xtest_features.txt');


y = csvread('../6000/y_time.txt');
yval = csvread('../6000/yval_time.txt');
ytest = csvread('../6000/ytest_time.txt');
