...
y_out = csvread('/Users/hrakebul/Documents/code/query-performance/dbpsb/svm/training_output.txt',1,2);
y_pred = y_out(:,1);

yval_out = csvread('/Users/hrakebul/Documents/code/query-performance/dbpsb/svm/val_output.txt',1,2);
yval_pred = yval_out(:,1);

ytest_out = csvread('/Users/hrakebul/Documents/code/query-performance/dbpsb/svm/test_output.txt',1,2);
...
th = title(['\fontsize{11}(c) SVM using algebra features (R^2=',num2str(rsq_test_score),')']);
...
th1 = title({'\fontsize{11}(d) RMSE for SVM using algebra features'});
