...
%load ('ex5data1.mat');
X = csvread('../1000/x_features.txt');
y = csvread('../1000/y_time.txt');
Xval = csvread('../1000/xval_features.txt');
yval = csvread('../1000/yval_time.txt');
Xtest = csvread('../1000/xtest_features.txt');
ytest = csvread('../1000/ytest_time.txt');

X_extra = csvread('../1000/x_features_simvec.txt');
Xval_extra = csvread('../1000/xval_features_simvec.txt');
Xtest_extra = csvread('../1000/xtest_features_simvec.txt');
...
%y_pred = X_poly * theta;
r2_training = r_square(y,y_pred); 
fprintf('R-square (training): %f \n',r2_training);
...
r2_test = r_square(ytest,ytest_pred); 
fprintf('R-square (test): %f \n',r2_test);
