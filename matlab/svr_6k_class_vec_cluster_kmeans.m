...
X_class = csvread('../6000/x_features_class_kmeans.txt');
Xval_class = csvread('../6000/xval_features_class_kmeans.txt');
Xtest_class = csvread('../6000/xtest_features_class_kmeans.txt');
