...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%% k_dm = 5 %k_nn = 2
y_pred_k5_knn2 = csvread('/Users/hrakebul/Documents/code/query-performance/dbpsb-K10/knn-k2/y_time_pred.txt',1,0);

yval_pred_k5_knn2 = csvread('/Users/hrakebul/Documents/code/query-performance/dbpsb-K10/knn-k2/yval_time_pred.txt',1,0);
ytest_pred_k5_knn2 = csvread('/Users/hrakebul/Documents/code/query-performance/dbpsb-K10/knn-k2/ytest_time_pred.txt',1,0);



y_pred = y_pred_k5_knn2;

yval_pred = yval_pred_k5_knn2;

ytest_pred = ytest_pred_k5_knn2;
...
th = title(['\fontsize{11}(a) k-NN using algebra and graph pattern features (R^2=',num2str(rsq_test_score),')']);
...
th1 = title({'\fontsize{11}(b) RMSE for k-NN using algebra and graph pattern features'});
