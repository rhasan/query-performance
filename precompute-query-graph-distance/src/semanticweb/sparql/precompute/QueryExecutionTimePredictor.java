...
public class QueryExecutionTimePredictor {
	...
	public QueryExecutionTimePredictor() throws Exception{
		
		config = new ProjectConfiguration();
		timeClusterer = new TimeClusterer();
		timeClassifier = new TimeClassClassifier();
		regressions = new HashMap<Integer, QueryExecutionTimePredictor.Regression4TimeClass>();
	...
	public void trainRegressions() throws Exception{
		...
		saveExecutionTimePredictions(predictedValues, config.getTrainingQueryExecutionTimesPredictedFile());
	...
	public void testExecutionTimePredictions() throws Exception {
		...
		saveExecutionTimePredictions(predictedValues, config.getTestQueryExecutionTimesPredictedFile());
		
		double rSquared = StatUtils.rSquared(originalValues, predictedValues);
		System.out.println("R-squared (test): "+rSquared);		
	}
	
	public void saveExecutionTimePredictions(double[] y, String fileName) throws IOException {
	...
	public static void main(String[] args) throws Exception {
		QueryExecutionTimePredictor predictor = new QueryExecutionTimePredictor();
